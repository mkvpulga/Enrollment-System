...
$pdf->Cell(189	,5,'SHS SECTION REPORT',0,1,'C');//end of line
...
$pdf->Cell(38	,5,'Section Description',1,0);
$pdf->Cell(38	,5,'# of Students',1,0);
$pdf->Cell(38	,5,'# of Subjects',1,0);
$pdf->Cell(37	,5,'Maximum Capacity',1,1);//end of line
...
$pdf->Cell(38	,5,$row['section_description'],1,0);
$pdf->Cell(38	,5,$row['num_of_students'],1,0);
$pdf->Cell(38	,5,$row['num_of_subjects'],1,0);
$pdf->Cell(37	,5,$row['capacity'],1,1,'R');//end of line

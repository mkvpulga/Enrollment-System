...
<div class="card shadow mb-4">
  <div class="card-header py-3">
     <h6 class="m-0 font-weight-bold text-primary"> UPDATE Student Grades
     ...
     $query_run1 = mysqli_query($connection,$query1);
      ...
      if(mysqli_num_rows($query_run1) > 0){
        while($row1 = mysqli_fetch_assoc($query_run1)){
            ...
            ?>
            <button type="submit" name="updatebtn" style="float: right;" class="btn btn-primary"> Update </button>
          </form>
           <form action="student_grades_grades.php" method="post">
                  <input type="hidden" name="student_id" value="<?php echo $student_id; ?>">
                  <input type="hidden" name="student_course_code" value="<?php echo $student_course_code; ?>">

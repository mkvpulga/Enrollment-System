...
?>
  ...
  $sid = '';
    ...
    if(isset($_POST['select_btn'])){
       ...
       if(isset($_POST['old_btn'])){
        $sid = $_POST['edit_id'];
        $student_type = $_POST['edit_stype'];
      }
 ...
 <div class="form-group">
  ...
  if(mysqli_num_rows($query_run1) > 0){
      ...
      ?>
                ...
                <input type="checkbox" name="<?php  echo $row['id']; ?>" value="<?php  echo $row['id']; ?>"  checked="">&nbsp;<?php  echo $row['clearance_name']; ?> <br>
                ...
                ?>
 <input type="checkbox" name="<?php  echo $row['id']; ?>" value="<?php  echo $row['id']; ?>" >&nbsp;<?php  echo $row['clearance_name']; ?> <br>
                <?php
              }
            }
                ?>
            ...
            if(isset($_POST['old_btn'])){
            ?>
             <button type="submit" name="studclearcreatebtnold" class="btn btn-primary"> Update </button>
             <?php
           }
             ?>
          </form>

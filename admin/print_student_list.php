...
//billing address
$pdf->Cell(100	,5,'List of Students',0,1);//end of line
...
$pdf->Cell(129	,5,'Student Full Name',1,0);
$pdf->Cell(20	,5,'Track',1,0);
$pdf->Cell(20	,5,'Grade',1,0);
$pdf->Cell(20	,5,'Semester',1,1);
...
//Numbers are right-aligned so we give 'R' after new line parameter
 ...
 while($row = mysqli_fetch_assoc($query_run)){
         $pdf->Cell(129	,5,$row['first_name'] . ' ' . $row['middle_name'] . ' ' . $row['last_name'] . ' ' . $row['suffix'],1,0);
$pdf->Cell(20	,5,$row['course_code'],1,0);
$pdf->Cell(20	,5,$row['year'],1,0);
$pdf->Cell(20	,5,$row['semester'],1,1);

...
$pdf->Cell(189	,5,'CLASS LIST',0,1,'C');//end of line


//set font to arial, regular, 12pt
$pdf->SetFont('Arial','B',12);
//billing address
$pdf->Cell(100	,5,$_SESSION['section_code'],0,0);//end of line
...
//Numbers are right-aligned so we give 'R' after new line parameter
 ...
 // $sstatus = $_SESSION['sstatus'] ;
  ...
  $query =  $_SESSION['class_list_query'];
...
$pdf->Cell(15	,5,$row['student_status'],1,1,'R');//end of line
